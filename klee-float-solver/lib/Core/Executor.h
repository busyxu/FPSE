...
//  void getConcreteAssignSeedBoolector(ExecutionState &state, bool &checkValid); // only boolector
    void getConcreteAssignSeedZ3(ExecutionState &state, bool &checkValid);  // only z3
    void getConcreteAssignSeedBitwuzla(ExecutionState &state, bool &checkValid, std::string filename);  //only bitwuzla
    ...
    void getConcreteAssignSeedDReal(ExecutionState &state, bool &checkValid); // only dreal
    void getConcreteAssignSeedCVC5Real(ExecutionState &state, bool &checkValid); // only cvc5-real
    void getConcreteAssignSeedMathSAT5Real(ExecutionState &state, bool &checkValid);  //only mathsat-real

    void getConcreteAssignSeedJFS(ExecutionState &state, bool &checkValid, int split_t);  // only jfs

    void getConcreteAssignSeedZ3GoSAT(ExecutionState &state, bool &checkValid);  // only GoSat
    void getConcreteAssignSeedZ3OptSAT(ExecutionState &state, bool &checkValid); // z3+gosat, z3 solver int var
    void getConcreteAssignSeedZ3QSampler(ExecutionState &state, bool &checkValid); // z3+gosat, z3 solver int var
    void getConcreteAssignSeedOptSAT(ExecutionState &state, bool &checkValid);  // only OptSat

    void getConcreteAssignSeedZ3DRealJFS(ExecutionState &state, bool &checkValid, std::string filename); // z3+dreal_jfs
    void getConcreteAssignSeedZ3JFS(ExecutionState &state, bool &checkValid); // z3+jfs
    void getConcreteAssignSeedZ3DReal(ExecutionState &state, bool &checkValid); //z3+dreal, z3 solver int var
