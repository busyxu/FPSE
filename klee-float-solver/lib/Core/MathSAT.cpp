...
namespace klee {
    ...
    void MathSATSolver::initSolver(){
      ...
      msat_set_option(cfg, "model_generation", "true");
        msat_set_option(cfg, "preprocessor.toplevel_propagation", "true");
        msat_set_option(cfg, "preprocessor.simplification", "1");
        msat_set_option(cfg, "dpll.branching_random_frequency", "0.01");
        msat_set_option(cfg, "dpll.branching_random_invalidate_phase_cache", "true");
        ...
        msat_set_option(cfg, "dpll.preprocessor.mode", "1");
        msat_set_option(cfg, "theory.bv.eager", "true");
        msat_set_option(cfg, "theory.bv.bit_blast_mode", "2");
        msat_set_option(cfg, "theory.bv.delay_propagated_eqs", "true");
        msat_set_option(cfg, "theory.arr.mode", "1");
        msat_set_option(cfg, "theory.la.enabled", "false");
        msat_set_option(cfg, "theory.eq_propagation", "false");
        msat_set_option(cfg, "theory.fp.mode", "1");
        msat_set_option(cfg, "theory.fp.bit_blast_mode", "2");
        msat_set_option(cfg, "theory.fp.bv_combination_enabled", "true");
