...
public:
  ...
  virtual std::string getSMTLIBString2(std::unordered_map<unsigned, std::string>& z3AstCache, std::unordered_map<unsigned, std::string>& z3DeclNameCache, std::vector<unsigned>& declOrder);
