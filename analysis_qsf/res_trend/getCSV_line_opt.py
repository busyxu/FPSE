...
def getDate():
  ...
  trend_file = "trend_results_opt.txt"
  bench_res = []
  flag = False
...
if __name__ == "__main__":
  ...
  # solver_type = ["smt", "bitwuzla", "mathsat5", "jfs", "gosat"]
  solver_type = ["smt", "bitwuzla", "mathsat5", "cvc5", "dreal-is", "jfs", "gosat-is", "gosat"]
  ...
  csv_trend_bfs = "csv_opt/trend_lines_bfs.csv"
  ...
  csv_trend_dfs = "csv_opt/trend_lines_dfs.csv"
