...
//        support z3-4.13.0 by yx
//        z3::expr_vector smt_expr_vector = smt_ctx.parse_file(opt_input_file.c_str());
//        z3::expr smt_expr = smt_expr_vector[0];
//        if(smt_expr_vector.size() > 1){
//            smt_expr = z3::mk_and(smt_expr_vector);
//        }
