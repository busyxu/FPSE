      ...
      integer NLOPT_GN_MOEA
      parameter (NLOPT_GN_MOEA=45)
      integer NLOPT_GN_MOCEA
      parameter (NLOPT_GN_MOCEA=46)
      integer NLOPT_GN_MOCEASP2
      parameter (NLOPT_GN_MOCEASP2=47)
      integer NLOPT_GN_MOCEASP3
      parameter (NLOPT_GN_MOCEASP3=48)
      integer NLOPT_GN_MOCEADS2
      parameter (NLOPT_GN_MOCEADS2=49)
      integer NLOPT_GN_MOCEADS3
      parameter (NLOPT_GN_MOCEADS3=50)
      integer NLOPT_GN_MOEADDS
      parameter (NLOPT_GN_MOEADDS=51)
      integer NLOPT_GN_MOEAI
      parameter (NLOPT_GN_MOEAI=52)
      integer NLOPT_GN_SOEAC
      parameter (NLOPT_GN_SOEAC=53)
      integer NLOPT_GN_SOEAD
      parameter (NLOPT_GN_SOEAD=54)
      integer NLOPT_GN_NSGA2
      parameter (NLOPT_GN_NSGA2=55)
      integer NLOPT_GN_AGS
      parameter (NLOPT_GN_AGS=56)
